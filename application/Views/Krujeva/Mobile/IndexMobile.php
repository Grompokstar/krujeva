...
<div class="mobile-about-company">
	...
	<div class="m-about-text">
		...
		Кружева объединяет в своём меню предложения для всех и каждого. В заведении используются исключительно
		натуральные ингредиенты лучшего качества, что порадует даже видавшего виды клиента. Кружева — это прекрасная
		подача меню и дизайн интерьера, который идеально подобран, чтобы дать гостям обстановку спокойствия и уюта.
	</div>

	<div class="m-about-img"></div>

	<div class="m-about-text">
		Благодаря этому проведенное в заведении время понравится всем, а внимательный персонал подскажет, на чем
		остановить ваше внимание и, в сочетании с галантным обслуживанием, принесет вам только позитивные эмоции.
	</div>

	<div class="m-about-img"></div>

	<div class="m-about-text">
		Кружева — это вкуснейшие блюда со всей Европы, блюда русской кухни, знакомые с детства, суши и роллы из свежих
		продуктов, отличное место для семейных праздников, уютную обстановку, внимательный персонал, вкусный кофе,
		бизнес-ланч для деловых людей, сыграть с друзьями в настольные игры. В заведении вы сможете отведать популярные
		блюда японской кухни. Каждому посетителю заведение предлагает высокоскоростной бесплатный Wi-Fi, кальян с
		табаком различного вкуса, услуги поваров и официантов для мероприятий.
	</div>
