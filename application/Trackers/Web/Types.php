...
namespace Trackers\Web {
	...
	class Types extends DataController {
		protected $record = 'Trackers\Data\Types';

		protected function prePage() {

			parent::prePage();

			$this->pageOptions['items'] = array_merge($this->pageOptions['items'], ['order' => 'name']);
		}
		...
		protected function preFind() {
			...
			$this->findOptions = array_merge($this->findOptions, ['order' => 'name', 'adjust']);
