Module.define(
	...
	function () {
		...
		KrujevaDict.UI.Widget.EditProductTasksForm = Class(Base.Form, {
			template: "KrujevaDict/Widget/EditProductTasksForm",
			...
			removeClick: function () {
				...
				var source = new KrujevaDict.Data.ProductTasks();
				...
				source.remove({id: record.id}, function (res) {
					...
					Loader.end(loader, function () {
						...
						if (res && res.item) {
							...
							Message.emit("KrujevaDict.ProductTasks.Insert", {item: res.item});
