Module.define(
	...
	function () {
		...
		KrujevaDict.UI.Widget.EditProductCategoriesForm = Class(Base.Form, {
			template: "KrujevaDict/Widget/EditProductCategoriesForm",
			...
			removeClick: function () {
				...
				var source = new KrujevaDict.Data.ProductCategories();
				...
				source.remove({id: record.id}, function (res) {
					...
					Loader.end(loader, function () {
						...
						if (res && res.item) {
							...
							Message.emit("KrujevaDict.ProductCategories.Insert", {item: res.item});
