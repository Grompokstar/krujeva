Module.define(
	...
	function () {
		...
		KrujevaMobile.UI.ProductForm = Class(KrujevaMobile.Page, KrujevaMobile.ListTrait, {
			template: "KrujevaMobile/ProductForm",
			...
			renderAdditionData: function () {
				...
				var html = UI.Template.render('KrujevaMobile/Product/Item', {widget: this, item: this.item});

				this.$name('data-item').html(html);

				if (this.item.usedescription) {

					var htmluse = UI.Template.render('KrujevaMobile/Product/UseItem', {widget: this, item: this.item});
