Module.define(
	...
	function () {
		...
		KrujevaMobile.UI.OrderCityForm = Class(KrujevaMobile.Page, KrujevaMobile.ListTrait, {
			...
			regionClick: function (caller) {
				...
				if (city) {
					...
					//history clear
					this.clearHistoryPages(['ordercity', 'orderaddress']);

					application.orderData['barbershop']['cityid'] = city['id'];

					application.open('orderaddress', {animate: true, backClick: true});
				}
			},
