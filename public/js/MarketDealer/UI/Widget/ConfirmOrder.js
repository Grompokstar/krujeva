Module.define("Base.Form",
	...
	function () {
		...
		KrujevaDealer.UI.Widget.ConfirmOrder = Class(Base.Form, {
			template: "KrujevaDealer/Widget/ConfirmOrder",
			...
			verifyClick: function () {
				...
				source.dealerconfirm({item: record, order: this.order}, function (data, result) {
