Module.define(
	"Base.Form",
	"Base.ListTrait",
	"KrujevaDealer.UI.Widget.AddPositionOrder",

	function () {
		NS("KrujevaDealer.UI.Orders");

		KrujevaDealer.UI.Orders.ViewForm = Class(Base.Form, {
			template: "KrujevaDealer/Orders/ViewForm",
            ...
            loadOrder: function () {
                ...
                var source = new KrujevaDealer.Data.Orders();

                source.dealerget({id: this.order.id}, function (data, result) {
			...
			cancelClicked: function () {
				...
				source.dealercancel({id: this.order.id}, function (data, result) {
			...
			verifyClicked: function () {
				...
				this.confirmForm = application.showWidget('KrujevaDealer.UI.Widget.ConfirmOrder', {animate: true, orderid: this.order.id, order: Util.clone(this.editOrder)});
			...
			addPositionClick: function () {
				...
				this.addForm = application.showWidget('KrujevaDealer.UI.Widget.AddPositionOrder', {animate: true, order: Util.clone(this.order) });
			...
			onProductAdd: function (args) {
				...
				//@render item
				var html = UI.Template.render('KrujevaDealer/Orders/ViewProductItem', {product: item});
			...
			printClick: function () {
				...
				myWindow.document.write(UI.Template.render('KrujevaDealer/Orders/Print', {order: this.order, editOrder: this.editOrder}));
