Module.define(
	...
	function () {
		...
		KrujevaBonus.Events = Static(Events, {
			...
			init: function () {
				...
				for (var record in data) if (data.hasOwnProperty(record)) {
					...
					this.listenDataEvent("Krujeva."+ record +".Insert", 'KrujevaBonus.Data.'+ record, {listen: true});
					this.listenDataEvent("Krujeva."+ record +".Update", 'KrujevaBonus.Data.'+ record, {listen: true});
					this.listenDataEvent("Krujeva."+ record +".Remove", 'KrujevaBonus.Data.'+ record, {listen: true});
				}

                this.listenOrderEvent();

				this.listenDataEvent("Krujeva.BonusOrders.Cancelled", 'KrujevaBonus.Data.BonusOrders', {listen: true});
				this.listenDataEvent("Krujeva.BonusOrders.Confirmed", 'KrujevaBonus.Data.BonusOrders', {listen: true});
			},

            listenOrderEvent: function () {

                var messageEvent = 'Krujeva.BonusOrders.NotNew';
